				...
				purchServList = ns.getPurchasedServers()
					...
					if (haveHost == true) {
						...
						if (sec < (minSec + 5) && money > (maxMoney * 0.5)) {
							ns.exec("BearOS/ammo/ch1.single.js", (nextHost), (currHack), (currTarg));
						}
						if (sec < (minSec + 5)) {
							ns.exec("BearOS/ammo/cg1.single.js", (nextHost), (currGrow), (currTarg));
						}
						ns.exec("BearOS/ammo/cw1.single.js", (nextHost), (currWeak), (currTarg));
