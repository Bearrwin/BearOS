...
export async function main(ns) {
	...
	ns.print("Current cycle time in ms is " + currCycle)
	ns.print("Current burst size is " + currBurst)

	const modify = await ns.prompt("Would you like to vhange the settinfs for Batcher 1", {
		type: "select",
		choices: ["Yes", "No"
		});
	...
	if (modify == "Yes") {
		...
		ns.write("BearOS/savedVar/10020201.txt", (_10020201), "w");
		ns.write("BearOS/savedVar/10020202.txt", (_10020202), "w");
		ns.write("BearOS/savedVar/10020203.txt", (_10020203), "w");
		ns.write("BearOS/savedVar/10020204.txt", (_10020204), "w");
		ns.write("BearOS/savedVar/10020205.txt", (_10020205), "w");
		ns.write("BearOS/savedVar/10020206.txt", (_10020206), "w");
