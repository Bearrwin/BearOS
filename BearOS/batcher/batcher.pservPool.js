...
export async function main(ns) {
	...
	let counterMax = 2400
		...
		let scriptOne = "BearOS/ammo/cw1.single.js"
		let scriptTwo = "BearOS/ammo/cg1.single.js"
		let scriptThree = "BearOS/ammo/ch1.single.js"
	...
	while (true) {
		...
		while (burstcounter > 0) {
			purchServList = ns.getPurchasedServers()
				...
				if (haveHost == true) {
					ns.exec("BearOS/ammo/ch1.single.js", (nextHost), (hackThreads), (hackTarget), (addHMSec));
					ns.exec("BearOS/ammo/cg1.single.js", (nextHost), (growThreads), (hackTarget), (addGMSec));
					ns.exec("BearOS/ammo/cw1.single.js", (nextHost), (weakThreads), (hackTarget));
